...
exports.getSolanaPrice = exports.getVaultUsdcBalance = exports.getVaultBalance = exports.getWalletAddress = exports.getCardTokenMint = exports.RPC_ENDPOINT = void 0;
...
const QUARTZ_SPEND_ADDRESS = new web3_js_1.PublicKey("jNFx1wSfb8CUxe8UZwfD3GnkBKvMqiUg69JHYM1Pi2G");
const QUARTZ_PROGRAM_ID = new web3_js_1.PublicKey("5Dxjir2yDi1aZAzgcnkEGmnLVop49DpNoru3c8DNAtcc"); // Devnet Quartz address
const USDC_MINT_ADDRESS = new web3_js_1.PublicKey("4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU"); // Devnet USDC address
...
const getVaultUsdcBalance = (connection, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const rawBalance = yield getVaultAtaBalance(connection, userId, USDC_MINT_ADDRESS);
